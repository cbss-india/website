...
const teamMembers = [
  {
    ...
    bio: "With an experience of over 40 years in the field of Biodiversity conservation, Dr. Hussain is amongst one of the pioneer conservation biologists of India. As a faculty member and later Head, Department of Landscape Level Conservation Planning at the Wildlife Institute of India, Dr. Hussain was managing projects on several aspects of wildlife conservation which includes terrestrial and aquatic ecology that includes coastal and marine habitat, and protected area management; Environment Impact Assessment and Social Impact Assessment of development projects; assessment of ecosystem services; community engagement in biodiversity conservation. His core competence is science-based biodiversity conservation planning at the large landscapes and riverscapes levels, ecological restoration of critical wildlife species and habitats, engaging communities in conservation, impact assessment of developmental projects and policy and advocacy for biodiversity conservation.",
              ...
              >
                <div className="grid lg:grid-cols-2">
                  ...
                  <div className="p-10 flex flex-col justify-center">
                    ...
                    <h2 className="text-4xl font-bold mb-3">{member.name}</h2>
                    ...
                    <a
                      ...
                      download
                      className="inline-flex items-center justify-center px-6 py-3 mt-6 text-sm font-medium rounded-md bg-primary text-primary-foreground hover:opacity-90 transition"
                    >
                      Download CV
                    </a>
                  </div>
